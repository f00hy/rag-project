...
from app.config import COLLECTION_NAME, OVERSAMPLING_FACTOR
from app.infra.qdrant import vec_db_client
from app.models import Embedding


async def search(embedding: Embedding) -> list[models.PointGroup]:
    ...
    Returns:
        List of point groups, each grouped by parent chunk ID.
    """
